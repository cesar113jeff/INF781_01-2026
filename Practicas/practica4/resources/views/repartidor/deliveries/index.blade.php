<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Mis Entregas</h2>
    </x-slot>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @forelse ($deliveries as $delivery)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $delivery->phone ?? '—' }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('repartidor.deliveries.show', $delivery) }}" class="text-indigo-600 hover:text-indigo-900">Ver</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">No tienes entregas asignadas.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
