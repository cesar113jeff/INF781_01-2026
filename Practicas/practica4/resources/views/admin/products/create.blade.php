                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.products.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" name="price" type="number" step="0.01" :value="old('price')" required />
                            <x-input-error :messages="$errors->get('price')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="stock" value="Stock inicial" />
                            <x-text-input id="stock" class="block mt-1 w-full" name="stock" type="number" :value="old('stock', 0)" required />
